...
var storageAccountNamingConvention = toLower('${replace(resourcePrefix, '-', '')}st${nameToken}unique_storage_token')
...
var hubLogStorageAccountUniqueName = replace(hubLogStorageAccountShortName, 'unique_storage_token', uniqueString(replace(resourcePrefix, '-', ''), resourceSuffix, hubSubscriptionId))
...
var identityLogStorageAccountUniqueName = replace(identityLogStorageAccountShortName, 'unique_storage_token', uniqueString(replace(resourcePrefix, '-', ''), resourceSuffix, identitySubscriptionId))
...
var operationsLogStorageAccountUniqueName = replace(operationsLogStorageAccountShortName, 'unique_storage_token', uniqueString(replace(resourcePrefix, '-', ''), resourceSuffix, operationsSubscriptionId))
...
var sharedServicesLogStorageAccountUniqueName = replace(sharedServicesLogStorageAccountShortName, 'unique_storage_token', uniqueString(replace(resourcePrefix, '-', ''), resourceSuffix, sharedServicesSubscriptionId))
